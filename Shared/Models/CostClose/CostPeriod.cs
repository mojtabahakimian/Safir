...
namespace Safir.Shared.Models.CostClose
{
    ...
    ///
    /// پایان ماه با CL_Tarikh محاسبه می‌شود (۲۹/۳۰/۳۱ بسته به ماه و سال
    /// کبیسه)، نه با یک روز ۳۱ ثابت — چون CC_Run.DateTo هم ذخیره و هم به
    /// کاربر نمایش داده می‌شود؛ یک تاریخ ساختگی مثل ۱۴۰۵۰۷۳۱ (مهر فقط
    /// ۳۰ روز دارد) در گزارش‌ها و تاریخچه گمراه‌کننده است.
    /// </summary>
    public static class CostPeriod
    {
        ...
        public static long To  (short year, byte month) => CL_Tarikh.GetPersianMonthEndAsLong(From(year, month));
