...
USING (VALUES
  (1, 1, 711, 1, 1.000000, 1, N'???? ???? ????', NULL, NULL),
  (2, 1, 712, 1, 1.000000, 1, N'???? ???? ??? - ??? ?????', NULL, NULL),
  (3, 1, 713, 1, 1.000000, 1, N'???? ???? ????? - ??? ?????', NULL, NULL),
  (4, 1, 721, 1, 1.000000, 1, N'??? ??????? ????', NULL, NULL),
  (5, 1, 723, 1, 1.000000, 1, N'??? ??????? ????? - ??? ?????', NULL, NULL),
  (6, 1, 745, 1, 1.000000, 1, N'??? ???? ???? ? ???', NULL, NULL),
  (7, 2, 743, 1, 1.000000, 1, N'??????? ?? ?', NULL, NULL),
...
USING (VALUES
  (N'CHK-01', N'?????? ????', N'S05', 1, 2, -1.0000000000000000e-002, N'????? ???? ?? ???? ?? ??????? ???? ?? ?????? ?? ??? ?????? ???? ???.', 1, 10, NULL, NULL),
  (N'CHK-02', N'????? ???? ??? ? ????????', N'S05', 2, 2, NULL, N'?????? ??????? ??? ?? ?????? ???? ??? ?? ????? ????? ?? ?? ?? ????. ??????? ?? ????? ????.', 1, 20, NULL, NULL),
  (N'CHK-03', N'???? ???? ? ??? ???? ?????', N'S00', 9, 1, NULL, N'?? ????? ???? ???? ????? ?? ?? ????. ??? ??? ?? ??? (??? ??? ??? ?? ???? ???)? ?? ?? ?? ??? ??????? ?????????? ??? ???? ?? ???? ??? ??.', 1, 30, NULL, NULL),
  (N'CHK-04', N'???? ???????? ???? ???? ??', N'S00', 12, 2, NULL, N'?? ?? ???? ???? ????? ?? ???. ?? ???? ???? ?? ?? ?? ??????.', 1, 40, N'CC_sp_Fix_MissingFormula', N'??? ?????? ????'),
  (N'CHK-05', N'?? ???? ??? ?', N'S00', 4, 1, NULL, N'??? ?? ?? ???? ???? ? ?? ???? ???? ?? ??? ?????? ?? ?? ????? ? ?? ?? ?? ??? ????? ????? ???? ?????. ?? ? ????? ????? ????.', 1, 50, NULL, NULL),
  (N'CHK-06', N'???? ?? ?????? ????', N'S00', 5, 2, NULL, N'??? ???? ?? ??????? ???? ?? ?? ?????. ?? ??? ???? ????? ???? ???? ? ???? ????.', 1, 60, NULL, NULL),
  (N'CHK-07', N'??? ???? ?? ?? ???? ???', N'S00', 13, 1, 1.0000000000000000e-003, N'??? ?? ?? ?? ????? ???? ?? ???? ???. ?????? ?? ?? ?? ???? ?? ?? ?? ???????? ???? ??? ? ???? ?? ??? ???.', 1, 70, NULL, NULL),
  (N'CHK-08', N'????? ??? ???? ????? ?? ??', N'S10', 10, 1, NULL, N'?? ???????? ??? ???? ??? ?? ???? ? ????? ????? ???. ???? ????? ?? ??????? ????.', 1, 80, NULL, NULL),
  (N'CHK-09', N'? ????? ??????????', N'S11', 14, 2, 1.0000000000000000e-003, N'??? ???? ???? ??? ??? ?? ?? ?? ?? ???? ????? ????? ???? ???????? ???? ???? ? ???? ??. ?? ?? ????? ???? ???? ?? ??? ??? ???? ?? ???.', 1, 90, NULL, NULL),
  (N'CHK-10', N'??? ???? ???? ?? ????? ????', N'S10', 8, 1, 1.0000000000000000e+007, N'?? ????? ?? ????? ???? ?? ??? ??? ???. ?????? ?? ?????? ???? ????? ??? ?? ??????? ???????? ??? ???? ??.', 1, 100, NULL, NULL),
  (N'CHK-11', N'???? ??? ?? ?????', N'S09', 11, 1, NULL, N'??? ?? ?? ??? ????? ?? ?? ??? ???? ????. ???? ???? ?? ???? ????????? ?? ????? ????.', 1, 110, NULL, NULL),
  (N'CHK-12', N'???? ?? ?? ?? ????? ????', N'S09', 15, 1, NULL, N'????? ?? ?? ?? ????? ???? ??? ???? ?? ??? ???? ???. ?????? ??? ????? ?? ?? ?? ?? ???.', 1, 120, NULL, NULL),
  (N'CHK-13', N'???? ?? ??? ??', N'S07', 16, 2, NULL, N'?? ?? ???? ??? ???? ??? ??????? ?? ??? ?? ???? ???? ???? ???? ?? ?? ???? ???? ?????? ??? ???. ???? ?? ???? ??????? ???.', 1, 130, NULL, NULL),
  (N'CHK-14', N'??? ???? ? ??????', N'S12', 17, 1, NULL, N'??? ??? ????? ??? ??? ?????? ? ?? ?????? ?? ???? ?? ??? ??????? ? ???? ?? ???? ??????. ?????? ??? ?? ????? ???? ?????? ???? ??? ???? ??? ??? ???.', 1, 140, NULL, NULL),
  (N'CHK-15', N'???? ?? ??? ????', N'S00', 17, 2, NULL, N'??? ???? ?? ?? ?? ???? ?? ??? ???? ? ??? ?????? ??? ???? ???? ?? ????? ???? (???) ??? ??? ???. ?? ???? ???? ?? ?? ?? ?? ?? ??? ????.', 1, 75, NULL, NULL),
  (N'CHK-16', N'???? ????? ?? ??? ???? ?? ????????', N'S00', 18, 1, NULL, N'??? ??? ?? ?? ?????? ?? ???? ???? ?????? (?? ????) ????? ???? - ????? ???? ????? ??? ?????? ?? ??? ??? ??? ??????? ? ??? ???? ??? ???? ??????.', 1, 45, NULL, NULL),
  (N'CHK-17', N'??? ???/??? ????????? ???? ????? ??? ???', N'S00', 19, 2, NULL, N'??? ??? ??? ??? ?? ?????? ????? ????? ????? ?? ??? ?? ??? ???/??? ?????. ???? NUM2/NUM3 ?? ?? ?????? ?? ??? ?? ???? - ??? ? ???? ??? ???????????? ??? ?? ?? ????? ? ??? ?????.', 1, 46, NULL, NULL),
  (N'CHK-18', N'??? ??? ?? ?? ?? ??? ????? ? ????/???? ?? ?????', N'S00', 20, 2, NULL, N'?? ???? ???? ????? ???? ??? - ?? ?????? ???? ?????? ?? ???? ???? ????? ???? ? ????? ???? ?? ???? ???? ?? ?? ???? ?? ?? ??? ???.', 1, 47, NULL, NULL),
  (N'CHK-19', N'????? ????? ?? ????? ?? ??????????? ??? ????', N'S00', 21, 1, NULL, N'?? ?????? ???? ?????? ?? ???? ???? ????? ???? ? ????? ???? ?? ???? ???? - ?????? ?? ?? ??? ????? ?? ????? (CHK-18) ??? ??????? ??? ?? ??? ??? ?????/???? ?? ??? ?????? ?? ?? ????????? ?? ?? ??????? ??.', 1, 48, NULL, NULL),
  (N'CHK-20', N'? ??????? ????', N'S00', 22, 1, NULL, N'??? ? ???? ?????? ???? ?? ?????? ???? (CHK-01) ?? ?????? ??? ???? ?? ???. ?? ????? ?? ????? ? ?? ???? ??? ??? ??? ?? ?? ???? ?? ? ????? ??? ??? ??? ????.', 1, 49, NULL, NULL),
  (N'CHK-21', N'????? ????? ??? ?? ????? ?? ??????????? ??? ????', N'S00', 23, 1, NULL, N'?? ?????? ???? ?????? ?? ???? ???? ????? ???? ? ????? ???? ?? ???? ???? - ?? ??? ??? ?? ??? ???? ?????? ??? ???? ?? ?? ??? ???? ?????? ??? ???????? ?? ??? ????? ? CHK-02 ?????? ???? ?? ?????.', 1, 50, NULL, NULL),
  (N'CHK-22', N'?????? ??? ???? - ??????? ? ????? ?', N'S11', 24, 2, NULL, N'?? ??? ? ?? ??????? ???? ????. ?????? ?????? ??????? ???? (CHK-01) ? ??? ??? ?? ???? ??? ??? ??? ??? ??. ?? ??? ??? ???? ??? ??? ??? ??? ?? ????/????? ?????? ?????? ?? ?? ????? ??? ??.', 1, 51, NULL, NULL)
