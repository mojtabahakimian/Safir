...
/* قاعده‌ي CHK-22 عمداً همين‌جاست و نه در 11-seed-data.sql: تنها جايي که
   ثبتش مي‌کند همين رويه است، و اگر seed جدا بماند مي‌شود همان تلهٔ
...
BEGIN
    ...
    /* ⚠️ ميرايي فقط روي جهشِ بزرگ، نه روي هر تغيير.
       ── مسئله ──
       ميرايي براي رام‌کردنِ واگرايي اضافه شد، ولي بي‌قيدوشرط روي *همه*
       اعمال مي‌شد. نتيجه‌اش روي کالاي سالم يک دنباله‌ي هندسيِ بيهوده بود:
       روي کد ۱۷۹۶ (کيسه شيري چاپ‌دار) فاصله ۱۴ → ۹ → ۶ → ۴ ريال شد،
       هر دور ۲۰ ثانيه، در حالي که همان دورِ اول مي‌شد مستقيم روي جواب
       نشست. هر دورِ اضافه S07A را هم با خودش مي‌کشد.

       ── چرا اين شرط امن است ──
       امضاي واگرايي جهشِ بزرگ است: زنجيره‌ي ۳۷۳→۱۷۳۲→۳۳۶۵ هر دور تقريباً
       دو برابر مي‌شد (۶۸۶→۱۴۰۹→۲۶۳۴، يعني تغييرِ ~۱۰۰٪). تصحيحِ عاديِ
       يک نرخ چنين نيست. پس بالاي ۱۰٪ ميرا مي‌شود — همان‌جا که محافظت
       لازم است — و زيرِ آن مستقيم پذيرفته مي‌شود.

       ── اگر اشتباه کنم چه مي‌شود ──
       بدترين حالت اين است که پذيرشِ کاملِ يک تغييرِ کوچک باعثِ نوسان
       (ping-pong) شود. آن حالت را تشخيصِ «جا زدن» در CloseOrchestrator
       مي‌گيرد (سه دورِ پياپي بدون کوچک‌شدن فاصله) و اجرا را با نامِ کالاي
    ...
    UPDATE  c
       SET  c.Mat = CASE
                      -- ميرايي فقط وقتي مقدارِ قبلي خودش ممکن باشد، و
                      -- فقط وقتي جهش به‌اندازه‌ي کافي بزرگ باشد که خطرِ
                      -- واگرايي داشته باشد. تغييرِ کوچک همان دور کامل
                      -- پذيرفته مي‌شود.
