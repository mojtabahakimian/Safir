...
USING (VALUES
 ...
 ('CHK-23', N'برگه بدون فاکتور یا سند حسابداری', 'S00', 25, 1, NULL,
  N'کالا از انبار رفته یا آمده و کاردکس آن را شمرده، ولی نه فاکتوری برایش بریده شده نه سندی. تا وقتی برگه ناتمام بماند، بهای تمام‌شده آن را می‌بیند و حسابداری نمی‌بیند — و CHK-02 همین را به‌صورت مغایرت نشان می‌دهد بدون اینکه ریشه‌اش را بگوید. برگه را در برنامه کامل کنید (فاکتور و سندش را بزنید)، یا اگر برگه اشتباه ثبت شده حذفش کنید.', 52)
