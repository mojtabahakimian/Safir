...
END;
GO
/****** Object:  UserDefinedFunction [dbo].[FN_PAY2_ACC_PARENT] ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE   FUNCTION [dbo].[FN_PAY2_ACC_PARENT](@CODE NVARCHAR(50))
RETURNS NVARCHAR(50)
AS
BEGIN
...
END
GO
/****** Object:  StoredProcedure [dbo].[SP_PAY2_GEN_DEED] ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
