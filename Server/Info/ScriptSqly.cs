...
";
                ...
                db.Execute(@"IF COL_LENGTH('dbo.PAY2_DECREE_LINE', 'NOMINAL_AMOUNT_OV') IS NULL ALTER TABLE dbo.PAY2_DECREE_LINE ADD NOMINAL_AMOUNT_OV DECIMAL(18,2) NULL;
...
BEGIN
    ...
    BEGIN
        ...
        IF NOT EXISTS (SELECT 1 FROM @ItemCalc WHERE ITEM_CODE = 'BASE_SAL' AND INS_AMOUNT <> 0)
        BEGIN
