-- ============================================================================
-- PAY2 v6.2 — پشتیبانی از مقادیر اعشاری برای اقلام ریالی (مخصوصاً درصد حق شیفت)
--
-- تغییرات:
--   ۱. تبدیل PAY2_DECREE_LINE.AMOUNT به DECIMAL(18,2)
--   ۲. تبدیل PAY2_ITEM_TMPL_LINE.DEF_AMOUNT به DECIMAL(18,2)
--   ۳. اصلاح پروسیجر SP_PAY2_CALC_RUN جهت پذیرش @ITEM_AMOUNT به عنوان اعشاری
-- ============================================================================

-- ۱. حذف قیدهای پیش‌فرض قبل از تغییر نوع
ALTER TABLE [dbo].[PAY2_DECREE_LINE] DROP CONSTRAINT IF EXISTS [DF_DL_AMT];
GO

ALTER TABLE [dbo].[PAY2_ITEM_TMPL_LINE] DROP CONSTRAINT IF EXISTS [DF_TL_AMT];
GO
...
ALTER TABLE [dbo].[PAY2_ITEM_TMPL_LINE] ALTER COLUMN [DEF_AMOUNT] DECIMAL(18,2) NOT NULL;
GO

-- ۳. ایجاد مجدد قیدهای پیش‌فرض
